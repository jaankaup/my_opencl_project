...
static std::string addPadding2(const std::string& str, const uint32_t count, const char paddingChar)
    {
...
static std::string vec_toString(const glm::vec2& object)
    {
      return "glm::vec2(" + std::to_string(object.x) + "," + std::to_string(object.y) + ")";
    }

static std::string vec_toString(const glm::ivec2& object)
    {
      return "glm::ivec2(" + std::to_string(object.x) + "," + std::to_string(object.y) + ")";
    }

static std::string vec_toString(const glm::vec3& object)
    {
      return "glm::vec3(" + std::to_string(object.x) + "," + std::to_string(object.y) + "," + std::to_string(object.z) + ")";
    }

static std::string vec_toString(const glm::vec4& object)
    {
      return "glm::vec4(" + std::to_string(object.x) + "," + std::to_string(object.y) + "," + std::to_string(object.z) + "," + std::to_string(object.w) + ")";
    }

static std::string vec_toString(const glm::mat3& object)
    {
      std::string padded = addPadding2("",std::string("glm::mat4").size() + 2 ,' ');
      std::string result = "\n  ";
...
static std::string vec_toString(const glm::mat4& object)
    {
      std::string padded = addPadding2("",std::string("glm::mat4").size() + 2 ,' ');
      std::string result = "\n  ";
...
class Log
{
  public:
    ...
    {
      std::string padded = addPadding2("",name.size(),' ');
